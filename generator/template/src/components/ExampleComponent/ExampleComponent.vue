...
<template>
  <div>
    ...
    <figure style="border-radius: 8px; margin: 12vh auto; width: 480px; background: #fafafa; box-shadow: 0 3px 6px rgba(0,0,0,.16); padding:45px 35px; box-sizing: border-box; text-align: center;">
      ...
      <a href="https://ericfennis.github.io/vue-cli-plugin-structure/">
        <img src="https://ericfennis.github.io/vue-cli-plugin-structure/logo-text.svg" alt="Vue Structure Logo" style=" margin-bottom:35px">
      </a>
      <figcaption style="display: flex; flex-shrink: 0; flex-grow:2; flex-basis: 80px; flex-direction: column; font-weight: 500;">
        <div style="display: flex; justify-content: space-around; margin-bottom: 20px;">
          <a href="https://ericfennis.github.io/vue-cli-plugin-structure/">Vue Structure docs</a>
