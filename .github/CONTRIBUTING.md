# Contributing to Vue CLI Plugin Structure
...
As a developer, you're the perfect candidate to help us improve our documentation. Typo corrections, error fixes, better explanations, more examples, etc. Open issues for things that could be improved. Anything. Even improvements to this document.
...
Do you have awesome ideas for Vue Structure? Don't hesitate, we are open to hear new ideas. Just create an issue.

## Reporting Issues

- Found a problem? Want a new feature? First of all, see if your issue or idea has [already been reported](https://github.com/ericfennis/vue-cli-plugin-structure/issues).
- If not, just open a [new clear and descriptive issue](https://github.com/ericfennis/vue-cli-plugin-structure/issues/new).
